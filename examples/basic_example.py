...
import os
hotkeys_json = os.path.join(hotkeys.__path__[0], 'hotkeys.json')
os.path.exists(hotkeys_json)

graph.set_context_menu_from_file(hotkeys_json)
...
n_basic_b.set_icon(r'''/Users/sgoda/Library/Preferences/Autodesk/maya/2024/scripts/star.png'''
